# [TwoSigma](https://twosigma.streamlit.app/) — Платформа для A/B тестирования
...
### 0. Если хочется быстро просто посмотреть что за платформа
 - Заходим на этот адрес https://twosigma.streamlit.app/ входим с этим логином: friwteg и паролем: friwteg. Там уже будут созданные несколько метрик и экспериментов.
